...
#print(crash_unit['PEDFLAG'].value_counts())
...
crash_unit['PEDFLAG'] = crash_unit['PEDFLAG'].replace('Y', 1)
crash_unit['PEDFLAG'] = crash_unit['PEDFLAG'].replace('N', 0)
print("PEDFLAG")

#save to csv
#crash_unit.to_csv('csv_files/modeling/nc18pedestrian_prelim', index=False)
...
#crash_unit = pd.read_csv('csv_files/modeling/nc18crash_unit.csv')
#road = pd.read_csv('csv_files/north_carolina/nc18road.csv')
...
#df = pd.read_csv('csv_files/modeling/nc18distracted_driving_prelim.csv')
